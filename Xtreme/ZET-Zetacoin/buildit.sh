...
# Build the ZET-Zetacoin executables from source code dated 2018-08.
...
docker build -t cd/zet-zetacoin:base -f Dockerfile.base . \
  --build-arg SOURCE_ORIGIN=https://github.com/zetacoin/zetacoin \
  --build-arg SOURCE_LOCAL_ROOT=/zetacoin \
  --build-arg COMMIT=57a012
